...
TEST_PATH_4=../machine-tasks/LookupTables/lookup-3bit/samples/sample1/new_compositions.tsv
EMB_SIZE=16
H_SIZE=512
DROPOUT_ENCODER=0
DROPOUT_DECODER=0
...
ENCODER_CELL='srn'
ENCODER_RNN_CELL_MASK_TYPE_INPUT='no-mask'
ENCODER_RNN_CELL_MASK_TYPE_HIDDEN='input'
ENCODER_RNN_CELL_MASK_CONIDTION_INPUT='x'
ENCODER_RNN_CELL_MASK_CONIDTION_HIDDEN='x_h'

DECODER_CELL='srn'
DECODER_RNN_CELL_MASK_TYPE_INPUT='feat'
DECODER_RNN_CELL_MASK_TYPE_HIDDEN='no-mask'
...
--encoder_cell $ENCODER_CELL --decoder_cell $DECODER_CELL --epoch $EPOCH --save_every $SAVE_EVERY \
--batch_size $BATCH_SIZE --dropout_p_encoder $DROPOUT_ENCODER --dropout_p_decoder $DROPOUT_DECODER \
