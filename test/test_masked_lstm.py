...
class TestMaskedLSTM(unittest.TestCase):
    ...
    def test_mask_wise(self):
        ...
        self.assertIsInstance(masked_lstm.W_f, torch.nn.Linear)
        self.assertIsInstance(masked_lstm.U_f, torch.nn.Linear)

        masked_lstm = MaskedLSTM(10, 5, 1,
                                 mask_input='feat', mask_hidden='feat')
        self.assertIsInstance(masked_lstm.W_f, MaskedLinear)
        self.assertIsInstance(masked_lstm.U_f, MaskedLinear)

        masked_lstm = MaskedLSTM(10, 5, 1,
                                 mask_input='elem', mask_hidden='elem')
        self.assertIsInstance(masked_lstm.W_f, MaskedLinear)
        self.assertIsInstance(masked_lstm.U_f, MaskedLinear)
    ...
    def test_packed_sequence(self):
        ...
        x = torch.nn.utils.rnn.pack_padded_sequence(
                ...
                batch_first=True)
        masked_lstm = MaskedLSTM(10, 5, 1,
                                 mask_input='feat', mask_hidden='elem')
        y, _ = masked_lstm(x)
