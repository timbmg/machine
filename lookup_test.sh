...
python train_model.py --train $TRAIN_PATH --dev $DEV_PATH --output_dir $EXPT_DIR --print_every 50 --embedding_size $EMB_SIZE --hidden_size $H_SIZE --rnn_cell $CELL --attention 'post-rnn' --attention_method 'hard' --epoch $EPOCH --save_every $CP_EVERY --teacher_forcing_ratio 0 --batch_size=1 --eval_batch_size=1 --scale_attention_loss 1 --optim adam
